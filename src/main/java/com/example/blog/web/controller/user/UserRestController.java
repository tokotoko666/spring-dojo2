...
public class UserRestController implements UsersApi {
    ...
    @Override
    public ResponseEntity<UserProfileUploadURLDTO> getProfileImageUploadURL(String fileName, String contentType, Long contentLength) {
        return ResponseEntity.ok(new UserProfileUploadURLDTO()
